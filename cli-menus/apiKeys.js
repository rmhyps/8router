const api = require("../cli-api/client");
const { prompt, confirm, pause } = require("../cli-utils/input");
const { clearScreen, showStatus, showHeader } = require("../cli-utils/display");
const { maskKey, formatDate, getRelativeTime } = require("../cli-utils/format");
const { showMenuWithBack } = require("../cli-utils/menuHelper");
const { copyToClipboard } = require("../cli-utils/clipboard");
...
async function showApiKeysMenu(port, breadcrumb = []) {
  const { showListMenu } = require("../cli-utils/menuHelper");
